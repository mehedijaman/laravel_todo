...
<body>
    <div class="min-h-screen w-screen bg-gradient-to-bl from-violet-300 to-sky-300 flex flex-col gap-2 p-10 items-center">
        <h1 class="text-xl text-white font-bold">Laravel Todo</h1>
        <div class="max-w-xl w-full bg-white p-5 rounded-md shadow-lg">
            ...
            <form action="/store" method="POST" enctype="multipart/form-data" class="grid grid-cols-12 gap-2">
                ...
                <div class="col-span-9">
                    <input class="w-full p-2 border focus:outline-none focus:border-blue-200 focus:shadow-lg" type="text" name="task" placeholder="Enter new Task Description">
                </div>
                <div class="col-span-3 flex items-center">
                    <button class="w-full py-2 bg-blue-400 text-white rounded-md font-medium hover:bg-sky-500  hover:cursor-pointer flex justify-center" type="submit" name="submit">
            ...
            @if(isset($EditTodo))
            <form action="/update/{{ $EditTodo->id }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-12">
                {{ csrf_field() }}
                <div class="col-span-9">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-2 border border-slate-300 flex gap-1 justify-end">
                            <form action="/done/{{ $Todo->id }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                            ...
                            <form action="/destroy/{{ $Todo->id }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                    ...
                    <tr>
                        ...
                        <td class="p-2 border border-slate-300 flex gap-1 justify-end">
                            <form action="/undo/{{ $Todo->id }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
